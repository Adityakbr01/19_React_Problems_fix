...
function RealTimebgChange() {
  ...
  return (
    ...
    >
      ...
      <input
        className="absolute top-[10%] left-[52%] text-black font-bold cursor-pointer"
        type="color"
        value={bg}
        onChange={(e) => setBg(e.target.value)}
      />
      <div className="absolute top-[16%] left-1/2 bg-zinc-200 px-8 py-2 text-black font-bold rounded-full cursor-pointer">
        {bg ? bg : "#242424"}
      </div>
    </div>
  );
